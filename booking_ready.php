...
// Insertion moved to booking_complete.php — booking_ready only shows summary and proceeds to confirmation page
// The previous insertion logic was here; it has been moved to booking_complete.php to support a confirmation step.
?>
...
function valid()
{
	...
	<div class="user_profile_info">	
        ...
        <form method="get" action="booking_confirm.php" name="sewa" onSubmit="return valid();"> 
          ...
          <input type="hidden" name="driver" value="<?php echo htmlentities($driver); ?>">
          <input type="hidden" name="pickup" value="<?php echo htmlentities($pickup); ?>">
        ...
        <input type="text" class="form-control" name="pickup_display" value="<?php echo $pickup;?>" readonly>
            </div>
            <div class="form-group">
        ...
        <input type="text" class="form-control" name="driver_cost_display" value="<?php echo format_rupiah($drivercharges);?>" readonly>
            </div>
            <div class="form-group">
			...
			<br/>			
			<div class="form-group">
                <input type="submit" name="submit" value="Lanjutkan ke Konfirmasi" class="btn btn-block">
            </div>
        </form>
		</div>
		</div>
